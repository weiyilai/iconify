...
function Component({mode: modeProp, fill: fillProp, focus: focusProp, static: staticProp, width: widthProp, height: heightProp, ...props}: Props) {
	const states = useMemo(() => ({ 'mode': namedStateValue(modeProp, 'auto'), 'fill': namedStateValue(fillProp, 'no-fill'), 'focus': focusProp, 'static': staticProp }), [modeProp, fillProp, focusProp, staticProp]);
