...
const props = defineProps(["mode","fill","focus","static","width","height"]);
...
<template><svg xmlns="http://www.w3.org/2000/svg" :class="className" v-bind="size" :viewBox="viewBox" v-html="content" /></template>
